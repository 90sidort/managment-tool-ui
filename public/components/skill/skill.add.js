...
var SkillAdd = /*#__PURE__*/function (_React$Component) {
  _inherits(SkillAdd, _React$Component);

  var _super = _createSuper(SkillAdd);
  ...
  function SkillAdd() {
    ...
    _this.onSkillSubmitHandler = _this.onSkillSubmitHandler.bind(_assertThisInitialized(_this));
    return _this;
  }
